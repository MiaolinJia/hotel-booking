...
import com.hotel.onlinebooking.ui.dto.recommendation.*;
...
public class RecommendationServiceImpl implements RecommendationService{
    ...
    public List<RecommendedPropertyDTO> getRecommendedProperties() {
        ...
        properties.add(RecommendedPropertyDTO.builder()
                .cityName("Neuruppin")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square600/239946673.webp?k=d4af6d47b2b73bc9e179d0433d12302101342eb891ffb7d0ac40b31d4142dcb7&o=")
                .id(6063591)
        ...
        properties.add(RecommendedPropertyDTO.builder()
                .cityName("Uig")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square600/261566046.webp?k=823cbc5e59ac91784d1c262d35ba4b89082a27d1222994e08e4647c29bd1c6db&o=")
                .id(5837006)
        ...
        properties.add(RecommendedPropertyDTO.builder()
                ...
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square600/236967822.webp?k=767dbb831d2109499cf73d2880a88e021a73781d7206cb812a328fd344756951&o=")
                .id(5724684)
        ...
        properties.add(RecommendedPropertyDTO.builder()
                ...
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square600/210942190.webp?k=0ad754ae6e916d21e9ec026fcf188284b6b8e6cb951561721cd416270a0af51a&o=")
                .id(5399147)
        ...
        properties.add(RecommendedPropertyDTO.builder()
                .cityName("Putten")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square600/218529186.webp?k=497b590292b9828d1e4ad797cfe30a51d40a193bca4a28efe88ee8a9d6809dd3&o=")
                .id(4567554)
        ...
        properties.add(RecommendedPropertyDTO.builder()
                .cityName("Simonsberg")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square240/178421525.webp?k=6c9cfca83aa49631c55eaed32fb7a6eb68573ffa76a47b23346504830249b853&o=")
                .id(4540189)
    ...
    public List<RecommendedDealDTO> getRecommendedDeals() {
        ...
        deals.add(RecommendedDealDTO.builder()
                .cityName("New York")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square240/180596947.jpg?k=cf4410d3ada8fcc33f005f6c3cc6524793719debc58cc598927d32786475dc68&o=")
                .id(1294230)
        ...
        deals.add(RecommendedDealDTO.builder()
                .cityName("Ocean City")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square240/315744922.jpg?k=6b772b6ce4bad143671a221d80b4f12a3fb750ed6a4c5ea6b7156d9578f46a44&o=")
                .id(307489)
        ...
        deals.add(RecommendedDealDTO.builder()
                .cityName("Orlando")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square240/183281202.jpg?k=ccef0be72c883ef46aa63beb35c368d1c28eb558418a7817186d89c13aa9bb5e&o=")
                .id(3316249)
        ...
        deals.add(RecommendedDealDTO.builder()
                .cityName("New York")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square240/303276079.jpg?k=7c641bb6a05b102ca99c07bf59d21a5c07eac5db177ac370139ca79ea1a4c348&o=")
                .id(4700797)
        ...
        deals.add(RecommendedDealDTO.builder()
                .cityName("Ocean City")
                .imageUrl("http://cf.bstatic.com/xdata/images/hotel/square240/560249073.jpg?k=98fc05818db9aab940f8b3bac6662562bda75637c3cb18966bf6b22282e7d39c&o=")
                .id(3278354)
